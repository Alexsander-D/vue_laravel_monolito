...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::get('/attendance/stock/export', [StockController::class, 'export'])->name('stock.export');
        Route::get('/attendance/stock/movements/export', [StockController::class, 'exportMovements'])->name('stock.movements.export');
