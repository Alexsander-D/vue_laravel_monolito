...
class Jetstream
{
     ...
     * @var string
     */
    public static $userModel = 'App\\Models\\Spatie\\User';
     ...
     * @var string
     */
    public static $teamModel = 'App\\Models\\Spatie\\Team';
     ...
     * @var string
     */
    public static $membershipModel = 'App\\Models\\Spatie\\Membership';
     ...
     * @var string
     */
    public static $teamInvitationModel = 'App\\Models\\Spatie\\TeamInvitation';
    ...
    /**
     * Retorna as roles que ja foram registradas pelo Jetstream.
     *
     * @return array
     */
    ...
    {
        // Foi adotado o Spatie para gestão de permissões.
