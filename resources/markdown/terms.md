...
Estes Termos de Serviço regem o acesso e o uso do serviço de lançamento de dados pós-venda fornecido por Grupo Multi. Ao acessar e utilizar o serviço, você concorda em cumprir integralmente com estes termos. Se você não concorda com qualquer parte dos termos, não utilize o serviço.

O usuário concorda em utilizar o serviço exclusivamente para fins lícitos, conforme descrito nestes termos. O usuário não deve:

Inserir dados falsos, incompletos ou fraudulentos;
Utilizar o serviço para realizar atividades ilícitas, incluindo, mas não se limitando a, fraude, roubo de identidade ou violação de direitos de propriedade intelectual;
Compartilhar sua senha de acesso ou permitir o acesso de terceiros não autorizados.
