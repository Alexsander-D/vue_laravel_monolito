...
<template #header>
  <header
    class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-gray-900 dark:border-gray-700"
  >
    <nav
      ...
      >
        ...
        <div class="justify-end gap-2">
          ...
          <div class="hs-dropdown [--placement:bottom-right] relative inline-flex">
            ...
            >
              <div class="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-gray-900">
