...
<template>
  <BaseLayout>
    ...
    <div class="w-full mx-auto pt-2">
      <!-- Card -->
      <div
        class="bg-white rounded-xl md:border border-gray-700 shadow p-4 dark:bg-gray-900"
      >
        <div class="mb-8 text-center">
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400 leading-tight">
          ...
          <div class="grid sm:grid-cols-12 gap-2 sm:gap-6 mt-8">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="hs-tooltip inline-block">
                <button type="button" class="hs-tooltip-toggle ms-1">
                  <svg
                    class="inline-block size-3 text-gray-400 dark:text-neutral-500"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
            ...
            <div class="sm:col-span-9">
              <input
                id="af-account-email"
                type="email"
                class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-900 dark:border-gray-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-red-600"
            ...
            <div class="sm:col-span-9">
              <div class="space-y-2">
                <input
                  ...
                  type="text"
                  class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-900 dark:border-gray-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-red-600"
              ...
              <div class="sm:flex">
                ...
                >
                  <input
                    ...
                    class="shrink-0 mt-0.5 border-gray-300 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-900 dark:border-neutral-500 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
            ...
            <div class="sm:col-span-9">
              <textarea
                id="af-account-bio"
                class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-900 dark:border-gray-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-red-600"
                rows="6"
