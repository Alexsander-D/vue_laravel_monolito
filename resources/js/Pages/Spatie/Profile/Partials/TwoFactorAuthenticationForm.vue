    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    Quando a autenticação de dois fatores estiver ativada, você será solicitado a fornecer um token
                    aleatório e seguro durante
                    autenticação. Você pode recuperar esse token no aplicativo Google Authenticator do seu telefone.
                </p>
            </div>
                ...
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            ...
                            telefone
                            aplicativo autenticador ou insira a chave de configuração e forneça o código OTP gerado.
                        </p>

                        <p v-else>
                            A autenticação de dois fatores agora está habilitada. Digitalize o seguinte código QR usando
                            o seu telefone
                            aplicativo autenticador ou insira a chave de configuração.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            ...
                            usados para recuperar o acesso
                            para sua conta se seu dispositivo de autenticação de dois fatores for perdido.
                        </p>
                    </div>
